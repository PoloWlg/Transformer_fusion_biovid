...
from models.models import  VIS_PHY_MODEL, MultimodalTransformer,VIS_PHY_MODEL_CONCAT
...
def test(test_annotation,concat_m_path, test_weight_vis_phy, test_weight_mm_transformer):
    ...
    val_acc, _ = validate_mmtransformer(vis_phy_model,mm_transformer, val_dataloader, criterion, device)
...
if __name__ == '__main__':
    ...
    for i in range (1,6):
        ...
        v_m_path = f'/projets2/AS84330/Projets/MM_transformer/biovid_codes/all_weights/weights_physio_viso2/model_best_vis_only_fold{i}.pth'
        phy_m_path = f'/projets2/AS84330/Projets/MM_transformer/biovid_codes/all_weights/weights_physio_viso2/model_best_gsr_fold{i}.pth'
