...
def train(train_annotation,test_annotation,v_m_path,phy_m_path,weight_path):
...
if __name__ == '__main__':
    ...
    for i in range (1,6):
        ...
        v_m_path = f'/projets2/AS84330/Projets/MM_transformer/biovid_codes/all_weights/temp_weights_visphy/model_best_vis_only_fold{i}.pth'
        phy_m_path = f'/projets2/AS84330/Projets/MM_transformer/biovid_codes/all_weights/temp_weights_visphy/model_best_gsr_fold{i}.pth'
        weight_name = f'model_best_feature_concat_fold{i}_'
        weight_path = os.path.join(dir_name,weight_name)
        best_accuracy = train(train_annotation,test_annotation,v_m_path,phy_m_path, weight_path)
...
#     for i in range (1,6):
#         test_annotation = f'test_fold{i}.txt'
#         v_m_path = f'/projets2/AS84330/Projets/MM_transformer/biovid_codes/all_weights/weights_physio_viso5_fps5_folddiff/model_best_vis_only_fold{i}.pth'
#         phy_m_path = f'/projets2/AS84330/Projets/MM_transformer/biovid_codes/all_weights/weights_physio_viso5_fps5_folddiff/model_best_gsr_fold{i}.pth'
