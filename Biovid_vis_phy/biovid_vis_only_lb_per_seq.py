...
import warnings
from models.models import Visual_model,Visual_model2 
from utils.util import remove_previous_files
...
def train(train_annotation,test_annotation,weight_path):
    ...
    visual_model = Visual_model2(num_classes=2)
...
if __name__ == '__main__':
    dir_name = '/projets2/AS84330/Projets/MM_transformer/biovid_codes/temp_weights4'
    os.mkdir(dir_name)
    kfold_accuracy = []
    for i in range (1,6):
